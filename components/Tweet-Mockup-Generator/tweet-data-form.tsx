...
export function TweetdataForm({ data, onChange }: TweetdataFormProps) {
  const handleChange = (
    section: Exclude<keyof Tweetdata, "theme">,
    key: string,
    value: any
  ) => {
    onChange({
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              handleChange("user", "isVerified", e.target.checked)
            }
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("content", "source", e.target.value)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleStatChange("likes", parseInt(e.target.value) || 0)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleStatChange("retweets", parseInt(e.target.value) || 0)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleStatChange("quotes", parseInt(e.target.value) || 0)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleStatChange("bookmarks", parseInt(e.target.value) || 0)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleStatChange("impressions", parseInt(e.target.value) || 0)
              }
              className="w-full p-2 rounded-lg border bg-gray-50 dark:bg-zinc-800 border-gray-200 dark:border-zinc-700"
            />
          </div>
